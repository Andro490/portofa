...
const UserProfile = () => {
        ...
        <div className="mb-12 relative">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
            <div className="flex flex-col items-center">
              ...
              <span className="text-sm text-slate-300 font-semibold mb-2">Total watched</span>
            ...
            <div className="flex flex-col items-center">
              ...
              <span className="text-sm text-slate-300 font-semibold mb-2">Completed exams</span>
            ...
            <div className="flex flex-col items-center">
              ...
              <span className="text-sm text-slate-300 font-semibold mb-2">Your general level</span>
        ...
        <div>
          ...
          <div className="flex flex-col gap-4 max-w-lg mx-auto">
            <div className="flex items-center justify-between border-b border-white/5 pb-4">
              <span className="text-sm text-slate-300">Total videos in your courses</span>
            ...
            <div className="flex items-center justify-between border-b border-white/5 pb-4">
              <span className="text-sm text-slate-300">Total completed</span>
            ...
            <div className="flex items-center justify-between border-b border-white/5 pb-4">
              <span className="text-sm text-slate-300">Completed courses (100%)</span>
            ...
            <div className="flex items-center justify-between border-b border-white/5 pb-4">
              <span className="text-sm text-slate-300">In-progress courses</span>
            ...
            <div className="flex items-center justify-between border-b border-white/5 pb-4">
              <span className="text-sm text-slate-300">Passed exams</span>
  ...
  const renderSubscriptions = () => (
    <div>
      <div className="flex flex-col items-center justify-center mb-10 text-center">
        <h2 className="text-3xl font-extrabold text-white mb-2">All Subscriptions</h2>
      ...
      {loadingCourses ? (
        ...
        <div className="text-center py-20">
          ...
          <p className="text-slate-400 text-sm mb-6">You haven't subscribed to any course yet.</p>
  ...
  const renderExamResults = () => (
    <div>
      <div className="flex flex-col items-center justify-center mb-10 text-center">
        <h2 className="text-3xl font-extrabold text-white mb-2">Exam Results</h2>
        <div className="h-1 w-24 bg-theme-neonCyan rounded-full mx-auto" />
      </div>
      ...
      {examResults.length > 0 ? (
        ...
        <div className="text-center py-20">
          ...
          <h3 className="text-lg font-semibold text-white mb-1">No exam results</h3>
  ...
  const renderHomeworkResults = () => (
    <div>
      <div className="flex flex-col items-center justify-center mb-10 text-center">
        <h2 className="text-3xl font-extrabold text-white mb-2 text-amber-400">Homework Results</h2>
      ...
      {homeworkResults.length > 0 ? (
        ...
        <div className="text-center py-20">
          ...
          <h3 className="text-lg font-semibold text-white mb-1">No homework results</h3>
          <p className="text-slate-400 text-sm">You haven't submitted any homework yet.</p>
        </div>
      )}
    </div>
  );
  ...
  const renderInvoices = () => (
    <div>
      <div className="flex flex-col items-center justify-center mb-10 text-center">
        <h2 className="text-3xl font-extrabold text-white mb-2">Invoices</h2>
        <div className="h-1 w-24 bg-theme-neonCyan rounded-full mx-auto" />
      </div>
      ...
      {loadingCourses ? (
          ...
          {courses.map((course) => (
            <div key={course.id} className="glass-panel p-5 rounded-xl border border-white/10 flex flex-col md:flex-row items-center justify-between gap-4">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h4 className="text-lg font-bold text-white mb-1">Invoice: {course.title}</h4>
                  <span className="text-xs text-slate-400">Date: {new Date(course.enrolledAt || new Date()).toLocaleDateString('ar-EG')} • Price: {course.price === 0 ? 'Free' : `${course.price} $`}</span>
                </div>
              </div>
              <div className="flex flex-col items-end gap-2">
                <button
        ...
        <div className="text-center py-20">
          ...
          <p className="text-slate-400 text-sm">You haven't made any payments yet.</p>
        </div>
      )}
    </div>
  );
      ...
      <div className="animate-fade-in">
        ...
        <div className="glass-panel p-6 rounded-xl border border-white/10 flex flex-col md:flex-row items-center justify-between gap-4 mb-8">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h3 className="text-xl font-bold text-white mb-1">Total Points</h3>
              <p className="text-sm text-slate-400">Points earned from your interaction</p>
            </div>
          </div>
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-4 mb-6">
          <h4 className="text-lg font-bold text-white">Point History ({filteredHistory.length})</h4>
          <div className="flex flex-wrap items-center gap-2 bg-slate-900/50 p-1.5 rounded-lg border border-white/5">
            <button onClick={() => setPointsFilter('all')} className={`px-4 py-1.5 rounded-md text-sm font-semibold transition-all ${pointsFilter === 'all' ? 'bg-theme-accent text-white' : 'text-slate-400 hover:text-white'}`}>All Points</button>
            <button onClick={() => setPointsFilter('videos')} className={`px-4 py-1.5 rounded-md text-sm font-semibold transition-all ${pointsFilter === 'videos' ? 'bg-theme-accent text-white' : 'text-slate-400 hover:text-white'}`}>Watching Videos</button>
            <button onClick={() => setPointsFilter('exam')} className={`px-4 py-1.5 rounded-md text-sm font-semibold transition-all ${pointsFilter === 'exam' ? 'bg-theme-accent text-white' : 'text-slate-400 hover:text-white'}`}>Exam</button>
