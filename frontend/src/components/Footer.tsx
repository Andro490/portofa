...
const Footer = () => {
  return (
    <footer className="relative z-10 border-t border-slate-200 dark:border-white/5 bg-theme-bg/60 backdrop-blur-md pt-16 pb-8 mt-24 rtl">
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-12">
        {/* Info Column */}
        <div className="flex flex-col gap-4">
          <div className="flex items-center gap-2">
            <div className="w-9 h-9 rounded-lg bg-linear-to-tr from-theme-accent to-theme-neonCyan flex items-center justify-center text-slate-900 dark:text-white">
      ...
      <div className="max-w-7xl mx-auto px-6 border-t border-slate-200 dark:border-white/5 mt-12 pt-6 flex flex-col sm:flex-row items-center justify-between text-xs text-slate-500 dark:text-slate-400 gap-4">
