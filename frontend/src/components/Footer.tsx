...
const Footer = () => {
  return (
    <footer className="relative z-10 border-t border-white/5 bg-theme-bg/60 backdrop-blur-md pt-16 pb-8 mt-24 rtl">
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-12">
        {/* Info Column */}
        <div className="flex flex-col gap-4">
          <div className="flex items-center gap-2">
            <div className="w-9 h-9 rounded-lg bg-linear-to-tr from-theme-accent to-theme-neonCyan flex items-center justify-center text-white">
        ...
        <div>
          ...
          <ul className="space-y-3 text-sm">
            <li>
              <Link to="/" className="text-slate-400 hover:text-theme-neonCyan transition-colors">
                الصفحة الرئيسية
              </Link>
            </li>
            <li>
              <Link to="/courses" className="text-slate-400 hover:text-theme-neonCyan transition-colors">
                جميع الدورات
              </Link>
            </li>
          </ul>
        ...
        {/* Tech Stack Column */}
        <div>
          <h4 className="text-white font-bold mb-4 font-sans">التقنيات المستخدمة</h4>
